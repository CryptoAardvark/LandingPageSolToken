...
export const getAvailablePoolKeyAndPoolInfo = async (connection) => {
  ...
  while (attempts < 5) {
    try {
      ...
      console.log(
        'DEBUG getAvailablePoolKeyAndPoolInfo: Success to get pool infos...'
      );
      break;
    } catch (error) {
      attempts++;
      ...
      console.log(
        'DEBUG getAvailablePoolKeyAndPoolInfo: Failed to get pool infos...'
      );
      console.log('DEBUG Retrying 5 seconds....');
      setTimeout(() => {}, 5000);
    }
  }
